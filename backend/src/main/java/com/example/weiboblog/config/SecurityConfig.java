...
import com.example.weiboblog.security.CustomUserDetailsService;
import com.example.weiboblog.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/home-ads/**").permitAll()
